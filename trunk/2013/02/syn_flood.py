...
source_ip = "%d.%d.%d.%d" % (172, 28, random.randint(1, 255), random.randint(1, 255))
dest_ip = '10.20.223.118'	# or socket.gethostbyname('www.google.com')
